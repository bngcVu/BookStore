...
- **Skills:** `frontend-design`, `clean-code`, `database-design`, `react-best-practices`
...
- **Skills:** `frontend-design`, `clean-code`, `database-design`, `testing-patterns`
...
- **Skills:** `frontend-design`, `clean-code`, `performance-profiling`, `api-patterns`
